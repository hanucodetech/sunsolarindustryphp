   ...
   <section class="pt-16 pb-7 bg-gray-900">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div class="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
                <div
                    ...
                    <div class="">
                        <h6 class="text-lg font-medium text-white mb-7 max-lg:text-center">Sun Solar</h6>
                        <ul class="flex flex-col max-lg:items-center gap-6">
                            ...
                            <li><a href="javascript:;"
                                    class="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Work</a>
                            </li>
                            <li><a href="javascript:;"
                                    class="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">Products
                                </a></li>
                        </ul>
                    </div>
                    <div class="">
                        <h6 class="text-lg font-medium text-white mb-7 max-lg:text-center">Services</h6>
            ...
            <div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-5 pt-7">
                ...
                <div class="relative  text-gray-500 focus-within:text-gray-900 ">
                    ...
                    <button type="button" id="default-search"
                        class="block w-full lg:min-w-[448px] pr-12 pl-6 py-3 text-base font-normal shadow-xs text-gray-50 bg-transparent border border-gray-700 rounded-full placeholder-gray-400 focus:outline-none leading-relaxed transition-all duration-500 ">Have
    ...
    <script>
        ...
        servicesButton.addEventListener('click', () => {
            servicesDropdown.classList.toggle('dropdown-hidden');
        });
        ...
        function type() {
            ...
            if (isDeleting) {
                currentText = currentWord.substring(0, textIndex - 1);
                textIndex--;
